    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://github.com/geraldioo" target="blank">Github</Button>
                    <Button href="https://linkedin.com/in/bryan-geraldio-9599842b8" target="blank">LinkedIn</Button>
                </ButtonContainer>
                    ...
                    isOpen && 
                            <MobileMenu isOpen={isOpen}>
                                ...
                                <MobileButtonContainer isOpen={isOpen}>
                                    <MobileButton href="https://github.com/geraldioo" target="blank">Github</MobileButton>
                                    <MobileButton href="https://linkedin.com/in/bryan-geraldio-9599842b8" target="blank">LinkedIn</MobileButton>
